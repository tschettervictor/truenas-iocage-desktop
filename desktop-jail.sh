#!/bin/sh
# Build an iocage jail under TrueNAS 13.0 and set up a desktop environment for use with XRDP or VNC
# git clone https://github.com/tschettervictor/truenas-iocage-desktop
...
INTERFACE="vnet0"
VNET="on"
JAIL_NAME="desktopjail"
CONFIG_NAME="desktopjail-config"
VNC=""
XRDP=""
GNOME=""
XFCE=""
...
# Check for desktopjail-config and set configuration
SCRIPT=$(readlink -f "$0")
